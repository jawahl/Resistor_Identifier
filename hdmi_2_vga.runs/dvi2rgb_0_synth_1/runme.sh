...
HD_PWD='C:/Users/jawah/hdmi_2_vga/hdmi_2_vga.runs/dvi2rgb_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dvi2rgb_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dvi2rgb_0.tcl
