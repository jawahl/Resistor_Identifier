...
HD_PWD='C:/Users/jawah/hdmi_2_vga/hdmi_2_vga.runs/rgb2vga_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2vga_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2vga_0.tcl
